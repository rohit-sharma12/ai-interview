...
const QuestionCard = ({
    ...
    return (
        <div className="bg-white rounded-b-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60 group">
            ...
            <div className="overflow-hidden transition-all duration-300 ease-in-out" style={{ maxHeight: `${height}px` }}>
                <div ref={contentRef} className="mt-4 text-gray-700 mg-gray-50 px-5 py-3 rounded-lg">
