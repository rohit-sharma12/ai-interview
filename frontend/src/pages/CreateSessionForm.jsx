...
const CreateSessionForm = () => {
  ...
  return (
    <div className='w-[90vw] md:w-[40vw] p-7 flex flex-col justify-center'>
      <h3 className='text-lg font-semibold text-black'>Start a New Interview</h3>
      <p className='text-xs font-semibold text-slate-700 mt-1 mb-3'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita dolorum saepe voluptates neque atque vero.
      </p>
